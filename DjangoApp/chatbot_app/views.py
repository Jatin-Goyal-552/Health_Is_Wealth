...
model = keras.models.load_model('..//All_Disease_Chatbot_Files//chatbot_model.h5')
intents = json.loads(open('..//All_Disease_Chatbot_Files//intents.json').read())
words = pickle.load(open('..//All_Disease_Chatbot_Files//words.pkl','rb'))
classes = pickle.load(open('..//All_Disease_Chatbot_Files//classes.pkl','rb'))
...
def predict_chat(request):
    ...
    tag = ""
    global prec, desc, sym, flag, temp_disease, all_symptoms, df_description,df_precautions, df_symptoms
